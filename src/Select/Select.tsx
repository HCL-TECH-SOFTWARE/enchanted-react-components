...
const getMuiSelectProps = (props: SelectProps): MuiSelectProps => {
  ...
  const muiTextFieldProps: MuiSelectProps = {
    ...
    endAdornment: <InputAdornment data-testid="endAdornment" position="end" onMouseDown={handleMouseDown} style={{ cursor: (props.disabled || props.readOnly) ? 'default' : 'pointer' }}>{getEndAdornment(props)}</InputAdornment>,
