...
const getVariantColor = (variant: SnackbarVariants, theme: Theme) => {
  switch (variant) {
    case SnackbarVariants.ERROR:
      return theme.palette.error.inverse;
    case SnackbarVariants.WARNING:
      return theme.palette.warning.inverse;
    case SnackbarVariants.SUCCESS:
      return theme.palette.success.inverse;
    case SnackbarVariants.INFO:
  ...
  (
    ...
    const filteredItems = useMemo(() => {
      return includeProgressInHeaderCounts
        ? items
        : items.filter((item) => item.variant !== SnackbarVariants.PROGRESS);
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px', flex: 1, minWidth: 0, overflow: 'hidden' }}>
              {showHeaderCounts && (
                <>
              ...
              {visibleItems.map((item, index) => (
                ...
                >
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px', flex: 1, minWidth: 0 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minWidth: '20px', flexShrink: 0 }}>
